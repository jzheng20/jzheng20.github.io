...
learning with applications to AI efficiency, safety & reliability of LLMs under resource constraints. My academic background spans art and design (B.A.), mathematics (M.S. and current Ph.D.), and computer science (completed Ph.D. degree).  I received the <a href="https://rbcborealis.com/program/fellowships/" style="font-weight:600; color:#1a4e8a; text-decoration:none;"> Borealis AI Fellowship</a> (awarded to ten AI researchers across Canada) and the Government Award for Outstanding Self-financed Students Abroad (awarded to 650 outstanding young talents worldwide).
